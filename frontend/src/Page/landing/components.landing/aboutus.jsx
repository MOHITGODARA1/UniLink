  ...
  return (
    <>
      <div className="w-full h-auto bg-black py-16 px-6 flex justify-center">
        ...
        <div className="w-[85%] rounded-xl p-10 relative 
          ...
          <div className="flex justify-center mb-4">
            <i className="ri-global-line text-6xl text-gray-400 animate-float"></i>
          </div>
          ...
          {/* Paragraph */}
          <p className="text-gray-400 text-md leading-relaxed text-center animate-fadeIn">
            ...
            Our platform highlights collaboration, transparency, and growth, ensuring that every 
            user feels valued and supported.
            <br /><br />
            With powerful tools, smart features, and a vibrant community, we aim to create an 
            ecosystem that encourages innovation at every step. From academic assistance to 
            project building and career networking, Unilink opens the door to endless possibilities.
            Together, we are shaping the future of student collaboration—one connection at a time.
          </p>
